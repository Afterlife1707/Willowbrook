...
public class FirstPersonController : MonoBehaviour
{
    ...
    public static FirstPersonController FPSInstance;
    ...
    private void Update()
    {
        if (Inworld.Sample.InworldPlayer.IsPanelOn)
            return;
        #region Camera
    ...
    private void Footsteps()
    {
        ...
        if (isSprinting)
        {
            AudioManager.SetRunClipAction?.Invoke();
        }
        else
        {
            AudioManager.SetWalkClipAction?.Invoke();
        }
    }
    private void Jump()
    {
    ...
    public void EnableDisablePlayerMovement(bool canMove)
    {
        cameraCanMove = canMove;
        playerCanMove = canMove;
        enableHeadBob = canMove;
    }
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            GameManager.ShowBlockerText?.Invoke();
        }
    }
